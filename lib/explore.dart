...
class _ExploreState extends State<Explore> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  buildTextSubTitleVariation1(
                      "Healthy and nutritions food recipes "),
                  SizedBox(
                    height: 32,
                  ),
                  Row(
  ...
  Widget option(String text, String img, int index) {
  ...
  Widget buildRecipe(Recipe recipe, int index) {
    return GestureDetector(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (_) => Detail(recipe : recipe)));
      },
      child: Container(
        decoration: BoxDecoration(
            color: Colors.white,
